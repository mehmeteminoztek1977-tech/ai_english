...
class _LessonScreenState extends State<LessonScreen> {
  ...
  void initState() {
    super.initState();
    unawaited(_initializeInt01());
  }

  Future<void> _initializeInt01() async {
    ...
    try {
      ...
      if (widget.videoController.value.duration <
        ...
        throw StateError(
          ...
          '(${contract.interaction.pauseAtMs} ms).',
        );
      }
      ...
      if (widget.autoPlay && !_session!.interactionVisible) {
          ...
          Positioned.fill(
            child: _Int01LocalizationScope(
              child: Int01Overlay(
                ...
                onFlowAction: widget.onInt01FlowAction,
              ),
            ),
          ),
        ],
